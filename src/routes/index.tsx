...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Émettez et gérez vos cartes virtuelles en quelques secondes. Multi-devises, sécurisées, mondiales." },
    ],
  }),
  component: Index,
});
...
const features = [
  { icon: Zap, title: "Émission instantanée", desc: "Créez une carte virtuelle en moins de 5 secondes, prête à payer partout." },
  { icon: ShieldCheck, title: "Sécurité bancaire", desc: "Chiffrement 256-bit, 3D Secure et tokens dynamiques pour chaque transaction." },
