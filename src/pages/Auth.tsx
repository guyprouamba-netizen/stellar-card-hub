      ...
      <div className="flex flex-col items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {mode === "login" ? "Connectez-vous à votre espace FASO INVEST PAY." : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            il faut noter que quelque soit le style choisit par l'utilisateur ^pour emettre ses factures le logo de la boutique doit remplacer le logo de la facture, pareille pour le nom et les information; et on doit mentionner quelque pars generer par faso-invest pay avec un code qr que l'on peut scanner pour reconnaitre l'authenticité de la facture et reconnaitre le vendeur.  j'ai remarque que c'est uniquement la facture qui est operationnel; mais les recus je ne vois pas les tickets de caisses je ne vois pas sans oublier les contrats. par defaut quelque soit le modele chosit les informations de la boutique doit remplacer les informations de l'entreprise du modèle"}
          </p>
