      ...
      <div className="flex flex-col items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {mode === "login" ? "Connectez-vous à votre espace FASO INVEST PAY." : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            For the code present, I get the error below.\n\nPlease think step-by-step in order to resolve it.\n```\nbuild failed with exit status 1: stderr:\nde-entry.js:23335:16)\n    at async rollupInternal (file:///dev-server/node_modules/rollup/dist/es/shared/node-entry.js:23860:5)\n    at async buildEnvironment (file:///dev-server/node_modules/vite/dist/node/chunks/config.js:33545:12)\n    at async Object.build (file:///dev-server/node_modules/vite/dist/node/chunks/config.js:33904:19)\n    at async Object.buildApp (file:///dev-server/node_modules/vite/dist/node/chunks/config.js:33901:153)\n    at async CAC.<anonymous> (file:///dev-server/node_modules/vite/dist/node/cli.js:629:3)\nerror: script \"build:dev\" exited with code 1\n\nstdout:\nvite v7.3.2 building client environment for development...\ntransforming...\n✓ 41 modules transformed.\n```"}
          </p>
