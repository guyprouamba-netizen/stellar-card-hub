...
const VerificationFooter = ({ business, invoice }) => {
    ...
    return (<div className="mt-12 pt-8 border-t border-slate-100 flex flex-col items-center justify-center text-center gap-4">
...
export const StripeModern = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-white p-8 sm:p-12 text-slate-900 font-sans max-w-4xl mx-auto shadow-sm border border-slate-100 rounded-xl">
      <div className="flex justify-between items-start">
        <div>
          {business.logo_url ? (<img src={business.logo_url} alt="Logo" className="h-12 w-auto mb-6"/>) : (<div className="h-12 w-12 rounded-lg bg-slate-100 flex items-center justify-center font-bold text-xl mb-6">
              {business.name[0]}
            </div>)}
      ...
      <table className="w-full mt-12 text-sm">
        ...
        <tbody className="divide-y divide-slate-100">
          {invoice.items.map((item, i) => (<tr key={i}>
      ...
      {invoice.notes && (<div className="mt-12 p-4 bg-slate-50 rounded-lg text-xs text-slate-500 leading-relaxed">
...
export const AppleMinimal = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-12 text-black font-sans max-w-4xl mx-auto">
      <div className="flex justify-between items-start mb-20">
        <h1 className="text-4xl font-black tracking-tighter">{title}</h1>
        <div className="text-right flex flex-col items-end">
          {business.logo_url ? (<img src={business.logo_url} alt="Logo" className="h-8 w-auto mb-2 grayscale"/>) : (<div className="h-8 w-8 rounded-full bg-black text-white flex items-center justify-center font-bold text-xs mb-2">
              {business.name[0]}
            </div>)}
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          {invoice.items.map((item, i) => (<div key={i} className="flex justify-between items-end py-2">
              <div>
...
export const BistroThermal = ({ invoice, business, kind = "receipt" }) => {
    return (<div className="bg-white p-6 text-black font-mono max-w-[320px] mx-auto text-xs border border-dashed border-slate-300">
      <div className="text-center mb-6 flex flex-col items-center">
        {business.logo_url ? (<img src={business.logo_url} alt="Logo" className="h-10 w-auto mb-2 grayscale contrast-200"/>) : null}
      ...
      <div className="space-y-2">
        {invoice.items.map((item, i) => (<div key={i} className="flex justify-between">
...
export const AmazonRetail = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-8 text-slate-900 font-sans max-w-4xl mx-auto border border-slate-200">
...
export const GovStandard = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-12 text-black font-serif max-w-4xl mx-auto border-4 border-double border-black">
      ...
      <table className="w-full border-collapse border border-black text-sm">
        ...
        <tbody>
          ...
          {[...Array(Math.max(0, 5 - invoice.items.length))].map((_, i) => (<tr key={`blank-${i}`} className="h-8">
...
export const StripeVintage = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#fcfcfc] p-10 font-serif max-w-2xl mx-auto border border-slate-200 shadow-xl">
    ...
    <div className="mt-8">
      <table className="w-full text-left">
        ...
        <tbody className="divide-y divide-slate-100">
          {invoice.items.map((it, i) => (<tr key={i} className="text-sm">
...
export const PaypalStatement = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-8 max-w-3xl mx-auto border border-blue-100">
      ...
      <div className="space-y-4 mb-8">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center text-sm border-b border-slate-50 pb-2">
...
export const QontoModern = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-12 max-w-4xl mx-auto text-slate-900 border border-slate-100 rounded-3xl">
      ...
      <div className="space-y-4 mb-16">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center py-4 border-b border-slate-50">
...
export const UberReceipt = ({ invoice, business, kind = "receipt" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-6 max-w-md mx-auto font-sans shadow-lg border-t-8 border-black">
      ...
      <div className="space-y-4 text-sm border-t border-b py-6 border-slate-100">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between">
...
export const LuxeMaison = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#1a1a1a] p-16 text-white font-serif max-w-4xl mx-auto tracking-widest uppercase text-center relative overflow-hidden">
      ...
      <div className="space-y-8 my-20">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center group">
...
export const GoogleCloud = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-white p-10 max-w-4xl mx-auto border border-slate-200 font-sans text-slate-800">
      ...
      <table className="w-full text-sm mb-10">
        ...
        <tbody className="divide-y divide-slate-200">
          {invoice.items.map((it, i) => (<tr key={i}>
              <td className="py-4">
...
export const AirbnbHost = ({ invoice, business, kind = "invoice" }) => {
    ...
    return (<div className="bg-white p-12 max-w-3xl mx-auto font-sans text-slate-900 border border-slate-100 rounded-lg shadow-2xl">
      ...
      <div className="bg-slate-50 p-8 rounded-2xl space-y-4 mb-10">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center border-b border-slate-200 pb-4 last:border-0 last:pb-0">
            <div>
...
export const WiseBorderless = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-[#252c32] p-10 max-w-4xl mx-auto text-white font-sans border border-slate-700">
      <div className="flex justify-between items-start mb-16">
...
export const MicrosoftAzure = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-12 max-w-4xl mx-auto border border-slate-200 font-sans text-slate-900">
      ...
      <table className="w-full text-sm border-t border-b border-slate-200 mb-10">
        ...
        <tbody>
          {invoice.items.map((it, i) => (<tr key={i} className="border-b border-slate-100 last:border-0">
...
export const RevolutBusiness = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-[#0e0e10] p-12 max-w-4xl mx-auto text-white font-sans border border-white/5 rounded-[2rem]">
...
export const NotaireOfficiel = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-[#fdfcf9] p-20 max-w-5xl mx-auto text-[#1a1a1a] font-serif border-x border-slate-200">
      ...
      <div className="space-y-6 text-sm leading-loose mb-20">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between border-b border-slate-100 pb-2">
...
export const DigitalNomad = ({ invoice, business, kind = "invoice" }) => {
    ...
    return (<div className="bg-[#f4f7f6] p-12 max-w-3xl mx-auto font-mono text-slate-800 border-2 border-slate-800 shadow-[8px_8px_0px_0px_rgba(30,41,59,1)]">
      ...
      <div className="space-y-8 mb-12">
        ...
        <div className="bg-white border-2 border-slate-800 p-6 space-y-4">
          {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center border-b border-slate-100 last:border-0 pb-2">
...
export const RetroTicket = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "RECEIPT" : kind === "contract" ? "CONTRACT" : "INVOICE";
    return (<div className="bg-[#121212] p-8 max-w-2xl mx-auto font-mono text-[#39ff14] border-4 border-[#39ff14] shadow-[0_0_20px_rgba(57,255,20,0.3)]">
      ...
      <div className="space-y-4 border-y-2 border-[#39ff14] border-dashed py-8 mb-8">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center text-xl">
...
export const CleanPharmacy = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-10 max-w-4xl mx-auto border-t-8 border-emerald-500 font-sans shadow-lg">
      <div className="flex justify-between items-start mb-12">
        <div className="flex items-center gap-3">
...
export const TechStartup = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "RECEIPT" : kind === "contract" ? "CONTRACT" : "INVOICE";
    return (<div className="bg-[#000000] p-12 max-w-4xl mx-auto text-white font-sans border border-white/10 rounded-xl overflow-hidden relative">
      ...
      <div className="space-y-4 mb-24 relative z-10">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center py-4 border-b border-white/5">
...
export const CoffeeShop = ({ invoice, business, kind = "receipt" }) => {
    const title = kind === "receipt" ? "RECEIPT" : kind === "contract" ? "CONTRACT" : "INVOICE";
    return (<div className="bg-[#fff9f0] p-8 max-w-[380px] mx-auto font-mono text-[#5d4037] border-2 border-[#d7ccc8] shadow-sm rounded-lg relative overflow-hidden">
...
export const HotelLuxe = ({ invoice, business, settings, kind = "invoice" }) => {
    ...
    return (<div className="bg-white p-16 max-w-5xl mx-auto text-[#2c3e50] font-serif border border-slate-100 shadow-2xl relative">
...
export const MinimalistBento = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#f8fafc] p-6 max-w-4xl mx-auto font-sans grid grid-cols-6 grid-rows-3 gap-4 h-[600px]">
...
export const ClassicRed = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-12 max-w-4xl mx-auto font-sans border-l-[12px] border-rose-600 shadow-xl">
      <div className="flex justify-between items-start mb-16">
        <div>
      ...
      <table className="w-full text-sm mb-16">
        ...
        <tbody>
          {invoice.items.map((it, i) => (<tr key={i} className="border-b border-slate-100">
...
export const NeonCyber = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#050505] p-12 max-w-4xl mx-auto text-cyan-400 font-mono border-[4px] border-cyan-500 shadow-[0_0_30px_rgba(6,182,212,0.5)] rounded-lg relative overflow-hidden">
      ...
      <div className="space-y-4 mb-20 relative z-10">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center group py-2 border-b border-cyan-500/20">
...
export const SoftMint = ({ invoice, business, settings, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#f0f9f4] p-12 max-w-4xl mx-auto font-sans text-[#2d5a43] border border-[#d1e7dd] rounded-[3rem] shadow-sm">
      <div className="flex justify-between items-start mb-24">
      ...
      <div className="space-y-6">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center group bg-white/50 p-6 rounded-[2rem] border border-[#d1e7dd]/50 hover:bg-white transition-colors duration-500">
...
export const DarkVanguard = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#0c0c0c] p-16 max-w-5xl mx-auto text-white font-sans border-t-[20px] border-indigo-600 shadow-2xl relative overflow-hidden">
      ...
      <div className="space-y-2 mb-32 relative z-10">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center py-8 border-b border-white/5 group hover:border-indigo-600 transition-colors duration-700">
...
export const OrganicKraft = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#e7d9c1] p-12 max-w-3xl mx-auto font-mono text-[#544a3d] border-[12px] border-[#cbbca1] shadow-inner relative">
      ...
      <div className="space-y-6 mb-16 border-y-4 border-[#544a3d] border-dotted py-12 relative z-10">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-start group">
...
export const BoldImpact = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-[#ffdd00] p-12 max-w-4xl mx-auto text-black font-black font-sans border-[16px] border-black shadow-[20px_20px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="space-y-8 mb-32">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center border-b-[8px] border-black pb-4 group hover:bg-black hover:text-[#ffdd00] transition-all duration-300 px-4">
...
export const ZenMinimal = ({ invoice, business, kind = "invoice" }) => {
    const title = kind === "receipt" ? "Reçu" : kind === "contract" ? "Contrat" : "Facture";
    return (<div className="bg-white p-20 max-w-5xl mx-auto text-slate-400 font-light font-serif tracking-[0.2em] uppercase text-center border-x border-slate-50 shadow-sm">
      ...
      <div className="space-y-12 mb-32">
        {invoice.items.map((it, i) => (<div key={i} className="flex justify-between items-center text-[10px] border-b border-slate-50 pb-8">
            <span>{it.name}</span>
